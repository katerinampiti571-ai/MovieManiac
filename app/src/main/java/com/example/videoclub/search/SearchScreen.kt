...
@Composable
fun SearchScreen(
    onNavigate: (SearchNavigationTarget) -> Unit
) {
        ...
        content = { padding ->
            Column(
                ...
                SearchBar(
                    ...
                    onValueChange = { onAction(SearchUiAction.SearchTermChanged(it)) },
                    shouldRequestFocus = true,
                    onClearClicked = { onAction(SearchUiAction.ClearClicked) },
                )
